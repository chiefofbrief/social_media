# Peter's Digest Video Prompt - V1: Mutiple Stories
...
Briefly answer the **STEP 1 QUESTIONS** above to justify the selection. Then, for each selected story:
...
*   **Consistency:** Maintain visual consistency across all scenes: style, color palette, character design, overall quality. Write prompts in flowing natural language, not bullet lists.
...
### Motion Rules
*   For each scene, produce one **Base Image** and a corresponding **Motion Prompt**.
...
*   **Miniature Aesthetic:** How does the visual make the most out of the miniature model style?
...
Briefly answer the **STEP 3 VISUAL QUESTIONS** above to justify the plan. Open with a brief **Guidelines** block noting the visual style. Then for each scene (starting with Scene 2):

Scene # — [Scene Title]
- **Base Image:** [Flowing natural language describing the handcrafted physical miniature set, lighting, and composition.]
- **Motion Prompt:** [Detailed camera movement and/or object motion relative to the Base Image.]
